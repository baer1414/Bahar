package Day_19;
import java.util.*;
public class String_Ornek_sorular {
    public static void main(String[] args) {
        ...
        //    System.out.println("kafka="+sozcuk("kafka"));
        //  System.out.println("salsa="+sozcuk("salsa"));
        // System.out.println("saksı"+sozcuk("saksı"));
        //  System.out.println(soyAdYazdır());
        // System.out.println(karekterSilerekYazma("akalar"));
        // System.out.println(terstenKelimeBenzer("kabak"));
        //  System.out.println(yineleme("java"));
        // System.out.println(ilkucKelime("ali"));
        // System.out.println(sonucKelime("ali"));
        // System.out.println(sadeceHarf("merha234ADF&%/.,ba"));
        ...
        // if(ardiArdinaHarf("aabccccseeeeeefff").length()==0){
        //      System.out.println("tekrarlayan harf yokktur");
        //  }

        // System.out.println(kelimeKacAdetVar("bursa ankara arası uzak"));
        //System.out.println(kacAdetsev("sev seni seveni sevmek guzeldir"));
        // System.out.println(unluUNsuz());
        //System.out.println(harfSayilari("merhaba"));
       // System.out.println(enCokDEgeriDonduren("eeemmmsssssssssshhhhhhhhhsss"));
