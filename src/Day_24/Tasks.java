...
//        System.out.println(arithmetic(sayılar2));
       // System.out.println(Arrays.toString(fillWithSmallestElement2(sayılar2)));
         ...
         String c="merhaba java insanları bugün nasılsınız";
          System.out.println(Arrays.deepToString(splitArry(c)));
...
//    onunla dolduran bir method yazın.
    ...
    public static String[][] splitArry(String str){
       String[] arr = str.split(" ");
        String[] a = Arrays.copyOfRange(arr,0,3);
        String[] b =Arrays.copyOfRange(arr,3,5);
        String[][] forReturn={a,b};
        return forReturn;
    }
